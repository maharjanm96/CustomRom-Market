...
const MobileDescription: React.FC = () => {
  ...
  return (
    <div className="flex flex-row justify-evenly items-start p-8">
      {/* Device Image and Action Buttons */}
      ...
      {/* Device Description and ROM Details */}
      <div className="flex flex-col">
        <h1 className="text-5xl font-bold">
          Xiaomi Poco F1{" "}
          <span className="text-custom border-2 bg-gray-200 rounded-xl text-sm px-2">
            BERYLLIUM
          </span>
        </h1>
